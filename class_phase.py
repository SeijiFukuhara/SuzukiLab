...
def make_phase_dict(img_phase_array, convolve_size_temp, z1, z2, x1, x2, x_axis_pix, width_phase, height_phase, n_apr_pix, gaussian_additive_term, d_micro_to_pix_temp):
    ...
    phase_offset_convolve_shift_dict = {"offset_convolve_centered": img_phase_array_offset_convolve_shift}
    #* integrate dict
    phase_full_array_dict = phase_original_dict | phase_offset_dict | phase_offset_convolve_dict | phase_offset_convolve_shift_dict | phase_apr_dict
